...
use App\Modules\Settings\Validators\DriverCancelReason as Validator;

class DriverCancelReason extends Model implements HasValidations
{
  use ModelDefaults;
   ...
   * @var string
   */
  protected $table = 'd_driver_cancel_reasons';
